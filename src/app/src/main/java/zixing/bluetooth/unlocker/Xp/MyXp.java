...
public class MyXp implements IXposedHookLoadPackage {
    ...
    public void handleLoadPackage(XC_LoadPackage.LoadPackageParam loadPackageParam) throws Throwable {
        if("zixing.bluetooth.unlocker".equals(loadPackageParam.packageName)) {

        XposedHelpers.findAndHookMethod(XposedHelpers.findClass("zixing.bluetooth.unlocker.activity.MainActivity",loadPackageParam.classLoader), "isXpEnable", new XC_MethodHook() {
            @Override
        ...
        else if ("com.android.settings".equals(loadPackageParam.packageName)) {
        ...
        else if("com.android.systemui".equals(loadPackageParam.packageName))
        {
            ...
            try {
                ...
                try{
                    ...
                    final XC_MethodHook.Unhook[] aaa = {null};
                    final XC_MethodHook.Unhook[] bbb = {null};
                    XposedHelpers.findAndHookMethod(XposedHelpers.findClass("com.android.keyguard.MiuiBleUnlockHelper", loadPackageParam.classLoader), "tryUnlockByBle", new XC_MethodHook() {
                        @Override
                        protected void beforeHookedMethod(MethodHookParam param) throws Throwable {
                            aaa[0] = XposedHelpers.findAndHookMethod(Toast.class, "makeText", Context.class, int.class, int.class, new XC_MethodHook() {
                                @Override
                                protected void beforeHookedMethod(MethodHookParam param) throws Throwable {
                                    ...
                                    if (Objects.equals(resName, "com.android.systemui:string/miui_keyguard_ble_unlock_succeed_msg")) {
                                        bbb[0] = XposedHelpers.findAndHookMethod(Toast.class, "show", new XC_MethodHook() {
                                            @Override
                                            protected void beforeHookedMethod(MethodHookParam param) throws Throwable {
                                                if (!("1".equals(ConfigUtil.getString("showtips", "1", 2)))) {
                                                    //不显示提示
